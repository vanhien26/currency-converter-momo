        ...
        <div>
          ...
          <div className="flex rounded-xl border-2 border-gray-200 p-3 bg-gradient-to-r from-white to-gray-50">
            ...
            <input
              ...
              placeholder="0"
              className="ml-3 flex-1 min-w-0 text-right text-3xl font-bold text-gray-900 bg-transparent outline-none placeholder:text-gray-400 overflow-hidden [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
            />
          </div>
        </div>
